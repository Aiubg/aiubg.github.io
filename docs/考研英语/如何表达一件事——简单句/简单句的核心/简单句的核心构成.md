...
想表达清楚一件事，写成一个简单句，就需要连词成句。而一件事最核心的两个构成部分就是“物质”和“运动”，所以简单句的核心就是“名词”和“动词”。
...
##### 主谓宾补 = 主语 + 及物动词 (vt.) + 宾语 + 宾语的补足语 (简称宾补)
...
| 系动词类别       | 常用词                          | 含义与用法                           | 真题例句                                                                 | 翻译                                                                 |
|------------------|---------------------------------|--------------------------------------|--------------------------------------------------------------------------|----------------------------------------------------------------------|
| **状态系动词**   | be                             | 表示"是"（纯粹状态）                 | Trust **is** a tricky business.                                          | 信任是一件复杂的事情。                                              |
|                  |                                 |                                      | Many discussions **are** not so successful.                              | 许多讨论并不那么成功。                                              |
| **变化系动词**   | get/become/turn/go/grow         | 表示"变得"（状态转变）               | Their behaviour **became** markedly different.                           | 他们的行为变得明显不同。                                            |
|                  |                                 |                                      | This attitude **becomes** a requirement for performers.                  | 这种态度成为演奏者的必备条件。                                      |
| **感官系动词**   | look/sound/smell/taste/feel     | 表示"感觉起来..."（感官判断）        | They **look** cute.                                                      | 它们看起来很可爱。                                                  |
|                  |                                 |                                      | Most folks **feel** comfortable about their ability...                   | 多数人对自己的能力感到满意...                                       |
| **表象持续系动词**| seem/appear/keep/remain/prove   | 表示"似乎/保持/证明"（判断或结果）   | The prospect **seems** remote.                                           | 前景似乎很渺茫。                                                    |
|                  |                                 |                                      | Unification **remains** a major goal.                                    | 统一仍是主要目标。                                                  |
|                  |                                 |                                      | The retreat **proved** painful.                                          | 这次撤退被证明是痛苦的。                                            |
